...
- 37: Mesh Shader
## 没整理的内容
- Layered Rendering： https://zhuanlan.zhihu.com/p/105837496
- Unreal Rendering: https://zhuanlan.zhihu.com/p/1970825479113114681 https://cdn2.unrealengine.com/Resources/files/2013SiggraphPresentationsNotes-26915738.pdf
- 3D Gaussian Splatting: https://zhuanlan.zhihu.com/p/1998742160586065432
- Nanite ： https://zhuanlan.zhihu.com/p/556062307
- HBAO: https://zhuanlan.zhihu.com/p/549146091
- frostbite: https://media.contentapi.ea.com/content/dam/eacom/frostbite/files/course-notes-moving-frostbite-to-pbr-v2.pdf
- Profiler: https://zhuanlan.zhihu.com/p/692168575 https://zhuanlan.zhihu.com/p/367122807 https://www.evolvebenchmark.com/blog-posts/learning-about-gpus-through-measuring-memory-bandwidth  https://zhuanlan.zhihu.com/p/448732749 https://zhuanlan.zhihu.com/p/1956845808163992205  https://blog.csdn.net/chenweiyu11962/article/details/140783467  https://developer.arm.com/documentation/111042/0100/CPU-performance https://docs.unity3d.com/Packages/com.unity.profiling.systemmetrics.mali@1.1/manual/metrics-guide.html https://zhuanlan.zhihu.com/p/670673683 https://zhuanlan.zhihu.com/p/20157065170 https://zhuanlan.zhihu.com/p/664575118 https://unity.com/how-to/profiling-and-debugging-tools
- 木卫四： Customize BRDF
- Filament: https://google.github.io/filament/Filament.md.html#lighting/imagebasedlights https://google.github.io/filament/Filament.md.html
- 体素： https://zhuanlan.zhihu.com/p/1999213285342470556
- Instruction Cache Misses: https://developer.nvidia.com/blog/improving-gpu-performance-by-reducing-instruction-cache-misses-2/ https://docs.qualcomm.com/doc/80-78185-2/topic/mobile_best_practices.html#mobile-instruction-count https://www.evolvebenchmark.com/blog-posts/learning-about-gpus-through-measuring-memory-bandwidth
- Sampler: https://zhuanlan.zhihu.com/p/25478857629  https://pema.dev/2025/05/09/mipmaps-too-much-detail/
- Compute shader: https://zhuanlan.zhihu.com/p/8013145261 https://zhuanlan.zhihu.com/p/714767350 
- Cluster rendering: https://zhuanlan.zhihu.com/p/109446948 https://www.cse.chalmers.se/~uffe/clustered_shading_preprint.pdf https://www.aortiz.me/2018/12/21/CG.html#tiled-shading--forward https://developer.nvidia.com/blog/visualizing-depth-precision/
- Load/Store action : https://zhuanlan.zhihu.com/p/1928114739189375482 https://developers.meta.com/horizon/blog/loads-stores-passes-and-advanced-gpu-pipelines/
- cubemap: https://learn.microsoft.com/en-au/windows/win32/direct3d9/cubic-environment-mapping?redirectedfrom=MSDN  https://community.khronos.org/t/better-generation-of-cubemap-mipmaps/53451 https://community.khronos.org/t/seams-in-cube-map/37599 https://www.cnblogs.com/minggoddess/p/14710294.html https://polycount.com/discussion/72365/blurred-cube-map-reflections https://www.alexisgiard.com/icosahedron-sphere/
- renderdoc: https://github.com/baldurk/renderdoc/issues/1215
- Fibonacci lattic （菲波那契网格）: https://zhuanlan.zhihu.com/p/25988652
- Left/Right Handed Coordinate System (左右手系)：  https://discussions.unity.com/t/unity-is-a-left-handed-coordinate-system-why/11897 https://discussions.unity.com/t/texture-is-flipped-after-graphics-copytexture-to-cubemap/758531/2 https://www.zhihu.com/column/p/28752675
- Fine Pruned Tiled Light Lists： https://www.cnblogs.com/OneStargazer/p/18097492
- Shader branching 分支判断: https://zhuanlan.zhihu.com/p/122467342
- OpenGLES Debug 调试： KHR_debug ： https://registry.khronos.org/OpenGL/extensions/KHR/KHR_debug.txt https://registry.khronos.org/OpenGL/specs/es/3.0/es_spec_3.0.withchanges.pdf https://registry.khronos.org/EGL/sdk/docs/man/html/eglQueryContext.xhtml
https://zhuanlan.zhihu.com/p/100140604
https://blog.csdn.net/fwy00/article/details/136188282
https://wikis.khronos.org/opengl/Category:Core_API_Ref_Debug
- Unity Memory Allocator: https://www.unishiki.cc/2022/10/09/performanceOptimization-28/ 
https://discussions.unity.com/t/what-is-tls-allocator-alloc_temp_thread-underlying-allocator-alloc_temp_thread-has-unfreed-allocations-and-how-do-i-fix-it/234837/9 
- ray tracing: https://antongerdelan.net/opengl/raycasting.html
- AVX : https://blog.csdn.net/JuicyActiveGilbert/article/details/146931862  https://lemire.me/blog/2024/01/11/implementing-the-missing-sign-instruction-in-avx-512/ https://stackoverflow.com/questions/24943521/which-is-the-reason-for-avx-floating-point-bitwise-logical-operations  https://blog.csdn.net/nbu_dahe/article/details/122157205
- 剧本: https://zhuanlan.zhihu.com/p/33733414 https://zhuanlan.zhihu.com/p/27162750
- Texture Format: https://openexr.com/en/latest/TechnicalIntroduction.html https://openexr.com/en/latest/ https://zhuanlan.zhihu.com/p/28695035732 https://zhuanlan.zhihu.com/p/373202297 https://qiankanglai.me/2018/07/22/hdr-texture/index.html 
- Fragment Density Map: https://zhuanlan.zhihu.com/p/1931149760485627883
- 角色渲染： https://zhuanlan.zhihu.com/p/29392904977
- super resolution: 
  - AMD FidelityFX https://discussions.unity.com/t/amd-fidelityfx-2-0/921379 https://github.com/GPUOpen-LibrariesAndSDKs/FidelityFX-SDK
  - STP : https://docs.unity3d.com/Packages/com.unity.render-pipelines.high-definition@17.0/manual/stp/stp-upscaler.html https://developers.cyberagent.co.jp/blog/archives/54536/
  - Accuracy Super Resolution: https://github.com/arm/accuracy-super-resolution-generic-library/blob/main/README.md https://www.arm.com/zh-tw/resources/blueprint/introducing-arm-accuracy-super-resolution
  - FSR 3.1 : https://github.com/ndepoel/FSR3Unity
  - FSR 2: https://zhuanlan.zhihu.com/p/490885528 https://zhuanlan.zhihu.com/p/532302889 https://zhuanlan.zhihu.com/p/630731970
  - FSR: https://zhuanlan.zhihu.com/p/401030221 https://zhuanlan.zhihu.com/p/637639295 https://atyuwen.github.io/posts/optimizing-fsr/ https://zhuanlan.zhihu.com/p/625503750
  - GSR: https://www.qualcomm.com/news/onq/2023/04/introducing-snapdragon-game-super-resolution
  - 凸包： https://zhuanlan.zhihu.com/p/340442313 https://zhuanlan.zhihu.com/p/707325000 https://zhuanlan.zhihu.com/p/508781004 
  - PSO Cache: https://dev.epicgames.com/documentation/unreal-engine/optimizing-rendering-with-pso-caches-in-unreal-engine?lang=zh-CN
## 知识点
- 1： 开启/关闭Vulkan
...
- 96： OBB碰撞需要检测15分离轴，其中包含六条法线，以及9条各个边叉乘后的结果。
  - OBB-AABB碰撞可以： 可以不通过叉乘运算得到9条各个边叉乘的结果，因为AABB的边是固定的。其与OBB各边叉乘的结果也是固定的：     
    ...
    ``` 
    而对于OBB在分离轴上的投影，如果使用先投影中心点，在投影Extends半长度的方式，可以将点乘数从8次将为4次。
    ```C++
    struct OBB {
    Vector3f center;      // 中心点 C
    Vector3f axes[3];     // 局部坐标轴 u1, u2, u3 (通常是旋转矩阵的列)
    Vector3f halfExtents; // 半长度 e1, e2, e3
    };

    inline void GetOBBProjection(const OBB& obb, const Vector3f& axis, float& minProj, float& maxProj)
    {
        // 1. 计算中心点在轴上的投影 Pc
        float pc = Dot(obb.center, axis);

        // 2. 计算投影半径 r
        // r = e1*|u1·L| + e2*|u2·L| + e3*|u3·L|
        float r = obb.halfExtents.x * std::abs(Dot(obb.axes[0], axis)) +
                  obb.halfExtents.y * std::abs(Dot(obb.axes[1], axis)) +
                  obb.halfExtents.z * std::abs(Dot(obb.axes[2], axis));
...
- 112: Texture2D贴图应用在sphere上时，uv为0 和 uv为1的相交的部分，在mipmap层级存在接缝(seam) -> 是因为Texture2D在使用filter生成mipmap时。 uv 为0 和uv为1的部分不会与小于0或大于1的部分进行混合，导致0和1的色差随mipmap level 增加而增加。 处理方式 -> 加padding保证0，1的部分也会混合。
...
- 122 : CG中在函数外直接声明（全局）变量 “const float A = 2.0” / “uniform float A = 2.0”好像是无效的，要么先在shader Property中声明，要么使用 #define，否则直接在函数中使用的A值是无效的。
- 123 : DX中纹理被抽象成Resource 和 View 两个对象，resource为纹理实际的内存，后者则是绑定到RWTexture2D 或 Texture2D时的对象。 一个纹理既可以声明为 RWTexture2D（UAV-type）在computer shader，也可以声明为 Texture2D（SRV-type）, 在fragment shader中。 一个资源可以同时绑定多个视图，但每个视图只能绑定到一个资源上。 https://learn.microsoft.com/en-au/windows/win32/direct3dhlsl/sm5-object-rwtexture2d
- 124：https://docs.unity3d.com/ScriptReference/ReflectionProbe-resolution.html Unity中，Reflection Probe在Runtime时如果使用的是realtime模式，调整resolution只会影响内部每帧生成的cubemap，但不影响最后blit到的，shader中使用的destination RT的分辨率（destination RT是最开始时创建并缓存的，即使改变resolution也不会变。）。 不清楚是feature还是bug？
- 125： C#中只读的property可以在构造函数中赋值。
- 126：Store/Load Action 与Memoryless: Store/Load action涉及了从tile memory到 RAM（不清楚是不是VRAM）的传输，会消耗带宽。 Memoryless则会将数据停留在tile memory 上，只在一个render pass中使用？![v2-9004c9b56edbf9bb7717dc1208940e85_1440w](https://raw.githubusercontent.com/hwubh/Temp-Pics/main/v2-9004c9b56edbf9bb7717dc1208940e85_1440w.png)
  ...
  - https://www.cnblogs.com/minggoddess/p/11236547.html
  ...
  - https://docs.unity3d.com/Packages/com.unity.render-pipelines.universal@10.9//api/UnityEngine.Rendering.Universal.StoreActionsOptimization.html
  ...
  - https://microsoft.github.io/DirectX-Specs/d3d/RenderPasses.html#allow-applications-to-avoid-unnecessary-loadsstores-of-resources-fromto-main-memory-on-tbdr-architectures
- 127： compute shader中将RWTexture的ID转为0~1之间时，需要除以的（TextureSize - 1）？
- 128: srp core中的GetLocalFrame函数在靠近Z=0时存在跳变，可以使用Frisvad 及其改进算法进行构建基向量坐标。 https://backend.orbit.dtu.dk/ws/portalfiles/portal/126824972/onb_frisvad_jgt2012_v2.pdf            
  ``` c
  real3x3 GetLocalFrame_Frisvad(real3 n) {
    // if(n.z < -0.9999999) // Handle the singularity
    //     return real3x3(real3(0.0, -1.0, 0.0), real3(-1.0, 0.0, 0.0), n);

    real a = 1.0 /(1.0 + n.z);
    real b = -n.x*n.y*a;
    real3 b1 = real3 (1.0 - n.x*n.x*a, b, -n.x);
    real3 b2 = real3 (b, 1.0 - n.y*n.y*a, -n.y);

    return real3x3(b1, b2, n);
  }
  ```
- 129: 为什么Untiy中negetive scale不会使模型的面内外相反 -> 因为打batch时会进行判断，如果时negative scale 会改变物体的朝向(winding order)
- 130: OpenGL 中自己声明的sampler要采样mipmap的话，得加上“MIPMAP”. e.g: FilterMode.trilinear = GL_LINEAR_MIPMAP_LINEAR。 如果只是声明LINEAR是不会采样mipmap的。 
  - https://registry.khronos.org/OpenGL-Refpages/gl4/html/glGetSamplerParameter.xhtml
  - https://community.khronos.org/t/mipmap-level-sampling-filters/44498
  - https://discussions.unity.com/t/texture-sampler-question-can-i-set-mip-filter-to-linear-but-min-filter-to-point/505514
- 131: 如果场景物体偏暗，可以看看是不是lighting（BakeGI）的问题
- 132： URP中如果要在打包时去除（strip）不需要的Keyword对应的变体，需要在`GetSupportedShaderFeaturesFromRenderer`中不保留该变体对应的KeyWord的ShaderFeature。 然后在CanRemoveVariant中，通过stripTool.StripMultiCompile剔除拥有该Keyword的变体。
- 133： 求单位法向量构建正交基： https://backend.orbit.dtu.dk/ws/portalfiles/portal/126824972/onb_frisvad_jgt2012_v2.pdf
  - Frisvad: 简练，但在Z = -1 出现奇异点NaN。
    ``` C#
    // https://backend.orbit.dtu.dk/ws/portalfiles/portal/126824972/onb_frisvad_jgt2012_v2.pdf
    float3x3 GetLocalFrame_Frisvad(float3 n)
    {
      // if(n.z < -0.9999999) // Handle the singularity
      //     return real3x3(real3(0.0, -1.0, 0.0), real3(-1.0, 0.0, 0.0), n);
  ...
  - Pixar: 简练，但在z=0， 可能等于1 或 -1.
    ...
    ```
- 134: Unity中Texture对象的内存分配： Managed(C#托管堆 UnityEngine.Texture2D 类的实例对象：本质为指向Native对象的内存指针和Texture的属性的元数据； 大多为几KB) + Native （非托管内存 C++层，贴图压缩后的硬件格式数据。 显存映射或常驻内存； 如果开启了RW则为两倍（多了一份常驻内存）； 如果开了Mipmap则为Mip0的 4/3 大小。） 
- 135： cmd.Blit不支持设置CubemapFace，底层写死了CubemapFace。

 ----------------
 - 阴影贴图的实现：比如如何决定视锥外的物体阴影的。 相机视锥体的参数。 -> 静态阴影贴图的更新方案，哪些物体需要呢？
 - VT的具体实现： 比如pagemap之类的。 一米一般分配多少像素。
 - std::forward / std::move函数的作用, 具体实践。
 - 图形学基础复习
 - unique_ptr 的实现
 - MAD 操作 -> GPU操作。 <- Wave
 - Visible Buffer